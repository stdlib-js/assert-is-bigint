...
```javascript
import isBigInt from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-bigint@v0.2.4-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-bigint/actions/workflows/test.yml/badge.svg?branch=v0.2.4
[test-url]: https://github.com/stdlib-js/assert-is-bigint/actions/workflows/test.yml?query=branch:v0.2.4
